...
public class MSServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // -------- SESSION CHECK (Fix for NullPointerException) --------
        HttpSession hs = request.getSession(false);
        ...
        pw.println("<button type='submit' style='background:green;color:white;padding:10px 20px;font-size:16px;border:none;border-radius:6px;cursor:pointer;'>Download PDF</button>");
        pw.println("</form>");
        pw.println("</div>");
        ...
        // -------- EXIT BUTTON --------
        pw.println("<form action='ATMScreen.html' method='get' style='text-align:center;margin-top:20px;'>");
        pw.println("<button type='submit' style='background:#444;color:white;padding:10px 20px;font-size:18px;border:none;border-radius:6px;cursor:pointer;'>Exit</button>");
        pw.println("</form>");
